...
#else
    font_family_->view()->window()->setWindowFlags(Qt::NoDropShadowWindowHint);
#endif
...
#else
    font_style_->view()->window()->setWindowFlags(Qt::NoDropShadowWindowHint);
#endif
...
#else
    font_size_->view()->window()->setWindowFlags(Qt::NoDropShadowWindowHint);
#endif
